<template>
  <div class="login-container">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <br>
      <el-button :loading="loading" style="width:100%;margin-bottom:30px;" @click.native.prevent="goLogin">已有帐号去登录</el-button>
  ...
  data() {
    ...
    return {
      ...
      registerRules: {
        ...
        repeatPwd: [{ required: true, trigger: 'blur', validator: validatePassword }]
      },
      loading: false,
  ...
  methods: {
    ...
    handleRegister() {
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          this.loading = true
          toRegister(this.registerForm).then(() => {
